...
FIRST_LINE_TEMPLATES: List[str] = [
    ...
    "The children never feared the {w}",
    "A stranger asked about the {w}",
    "In summer heat they chased the {w}",
    "The sailor sang about the {w}",
    "Long after midnight came the {w}",
    "She traced a finger on the {w}",
    "The soldiers marched into the {w}",
    "No map could lead them to the {w}",
    "The painter tried to catch the {w}",
    "They buried deep beneath the {w}",
    "A single candle lit the {w}",
    "The river carried off the {w}",
    "He could not quite forget the {w}",
    "Each evening brought a kind of {w}",
    "The mountain path revealed the {w}",
    "Her mother warned her of the {w}",
    "Somewhere below the town lay {w}",
    "The dancers moved as if in {w}",
    "A whispered rumor of the {w}",
    "The engine roared and then the {w}",
    "We spoke in silence of the {w}",
    "The empty house was filled with {w}",
    "Beyond the harbor lies the {w}",
    "The teacher told them of the {w}",
    "A sudden storm announced the {w}",
]
...
SEED_RHYME_WORDS: List[str] = [
    ...
    "pain", "joy", "grace", "smile", "tear", "fear", "hope", "storm",
    "gloom", "friend", "king", "queen", "crown", "sword", "ghost", "grave",
    "light", "bright", "sight", "blue", "true", "few", "art", "part",
    "mind", "kind", "find", "line", "shine", "wine", "small", "call",
    "face", "place", "space", "race", "name", "game", "fame", "shame",
    "town", "crown", "care", "air", "chair", "prayer", "bread", "thread",
]
